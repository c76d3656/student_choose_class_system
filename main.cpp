...
const std::map<unsigned int, std::string> course_nature_list = {{1, "公共必修"},
                                                                {2, "学科必修"},
                                                                {3, "学科选修"},
                                                                {4, "专业必修"},
                                                                {5, "专业选修"},
...
public:
    ...
    ClassInformation(const std::string &Course_name, unsigned int Course_nature, unsigned int Total_hours,
